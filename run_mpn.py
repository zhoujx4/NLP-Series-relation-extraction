...
from dataset.dataset_mpn import mpn_DuIEDataset, read_examples
from models.model_mpn import ERENet
from mpn_evaluation import convert_spo_contour, convert2ressult, run_evaluate
...
def main():
    ...
    # model
    model = ERENet.from_pretrained(args.model_name_or_path, classes_num=len(args.spo_conf))
    ...
    for epoch, _ in enumerate(range(int(args.num_train_epochs))):
        ...
        if res_dev['f1'] >= best_f1:
            ...
            torch.save(best_model.state_dict(),
                       os.path.join(args.output_dir, "mpn_{}_{}.pkl".format(os.path.split(args.model_name_or_path)[1], args.time)),
